            ...
            switch (operation) {
                ...
                case 'factorial':
                    if (!Number.isInteger(inputValue) || inputValue < 0) {
                        throw new Error('El factorial requiere un número entero no negativo');
                    }
            ...
            <div className={`button-grid ${isScientific ? 'scientific' : 'basic'}`}>
                {isScientific ? (
                    <>
                        ...
                        <button className="scientific-function" onClick={() => performScientificOperation('sin')}>sin</button>
                        <button className="scientific-function" onClick={() => performScientificOperation('cos')}>cos</button>
                        <button className="scientific-function" onClick={() => performScientificOperation('tan')}>tan</button>
                        <button className="scientific-function" onClick={() => performScientificOperation('log')}>log</button>
                        
                        {/* Segunda fila - Funciones matemáticas */}
                        <button className="scientific-function" onClick={() => performScientificOperation('sqrt')}>√</button>
                        <button className="scientific-function" onClick={() => performScientificOperation('factorial')}>x!</button>
                        <button className="scientific-function" onClick={() => performScientificOperation('abs')}>|x|</button>
                        <button className="scientific-function" onClick={() => performOperation('^')}>x^y</button>
                        
                        {/* Tercera fila - Operaciones básicas */}
                        <button className="function" onClick={clear}>AC</button>
                        <button className="function" onClick={() => performOperation('%')}>%</button>
                        <button className="function" onClick={() => performOperation('/')}>/</button>
                        ...
                        <button className="operator equals" onClick={calculate}>=</button>
                    ...
                    <>
                        ...
                        <button onClick={() => inputDigit(2)}>2</button>
                        <button onClick={() => inputDigit(3)}>3</button>
                        <button className="operator equals" onClick={calculate} rowSpan="2">=</button>
